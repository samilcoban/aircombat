...
class Entity:
    ...
    # Position and Orientation (Geodetic coordinates)
...
class AirCombatCore:
    ...
    def spawn(self, lat, lon, heading, speed, team, etype):
        ...
        e = Entity(
            ...
            lat=lat, lon=lon, alt=10000.0,  # Default spawn altitude at 10km
    ...
    def _update_missile(self, ent):
        ...
        # Update position using geodetic navigation
        ent.lat, ent.lon = geodetic_direct(ent.lat, ent.lon, ent.heading, dist)
    ...
    def _resolve_collisions(self):
        ...
        for m in missiles:
            ...
            if m.target_id in self.entities:
                ...
                # Proximity fuse: Trigger if within 1km
                if dist < 1.0:
